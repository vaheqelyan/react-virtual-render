...
export default class HorizontalList extends React.Component {
  ...
  handleScroll = () => {
    ...
    const offset = this.base.scrollLeft;
    ...
    let selection = this.props.data.slice(start, end);
  ...
  render() {
    ...
    const { className, rowWidth, data, renderRow } = props;

    return (
      <div ref={setBase} className={className} onScroll={handleScroll} {...props}>
        <div
          style={{
            position: "relative",
            overflow: "hidden",
